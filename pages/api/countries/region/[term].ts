...
export default function handler(
  ...
  async function getCountriesByRegion() {
    let countries: any[] = [];
    let url = `${restCountriesApi}/region/${region}`;
